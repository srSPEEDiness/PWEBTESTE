#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR VIRTUAL NET\033[0m"
...
wget https://github.com/srSPEEDiness/PWEBTESTE/raw/main/install/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/srSPEEDiness/PWEBTESTE/raw/main/install/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/srSPEEDiness/PWEBTESTE/raw/main/install/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/srSPEEDiness/PWEBTESTE/raw/main/install/sincpainel.zip > /dev/null 2>&1
